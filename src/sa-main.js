...
import saModule from 'plat-sa-lib'
import 'plat-sa-lib/dist/sa-web.css'
import { GET_TOKEN, UPDATE_TOKEN, GET_CURRENT_CLIENT } from '@/store/_constant'
import saAxios from '@/services/saAxios'
...
const SA_API_CONFIG = {
  baseUrl: process.env.VUE_APP_SA_API_BASE_URL || ''
}
...
Vue.use(saModule, { store, router, layout, nav, retryOn401, SA_API_CONFIG, customSidebar })
